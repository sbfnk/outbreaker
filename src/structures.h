...
typedef struct{
    ...
    double mu1; /* rate of transitions and its prior */
    char* mu1_prior; /* prior distribution of mutation rate */
    vec_double *mu1_prior_params; /* prior parameters of mutation rate */
